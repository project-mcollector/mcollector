  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setError(text || "Не удалось сбросить пароль. Ссылка могла устареть.");
        return;
      }
  ...
  return (
    <div className={styles.page}>
      <div className={styles.card}>
        ...
        {!userId || !token ? (
          <>
            <p className={styles.subtitle}>Неверная ссылка</p>
            <p className={styles.linkText}>
              <Link href="/forgot-password" className={styles.link}>Запросить новую</Link>
            </p>
          </>
        ) : done ? (
          <>
            <p className={styles.subtitle}>Пароль изменён</p>
