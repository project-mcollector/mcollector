    ...
    <div className={styles.page}>
      <div className={styles.header}>
        <div>
          <h1 className={styles.title}>{t("heading")}</h1>
          {projects.length > 0 && (
            <p className={styles.subtitle}>{t("projectCount", { count: projects.length })}</p>
          )}
        </div>
      </div>
      ...
      {projects.length === 0 ? (
        ...
        <div className={styles.projectsGrid}>
          {filteredProjects.length === 0 && (
            <p className={styles.emptyState}>{t("nothingFound")}</p>
          )}
              ...
              <div className={styles.projectApiKeyRow}>
                ...
                <div className={styles.apiKeyActions}>
                  <button
                    ...
                    title={visibleKeys.has(project.id) ? t("hideKey") : t("showKey")}
                  >
      ...
      <div className={styles.createSection}>
        <p className={styles.createTitle}>{t("createTitle")}</p>
      ...
      {apiKeyModal && (
        <div className={styles.modalOverlay} onClick={() => setApiKeyModal(null)}>
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            <h2 className={styles.modalTitle}>{t("apiKeyTitle")}</h2>
            <p className={styles.modalSubtitle}>{apiKeyModal.name}</p>

            <label className={styles.label}>{t("currentKey")}</label>
            ...
            {!apiKeyRegenerateConfirm ? (
              ...
              <div className={styles.regenerateConfirmBox}>
                <p className={styles.regenerateWarning}>{t("regenerateWarning")}</p>
                <div style={{ display: "flex", gap: 8 }}>
                  ...
                  >
                    {regenerating ? t("generating") : t("confirmRegenerate")}
                  </button>
                  <button
                    className={styles.buttonOutline}
      ...
      {createdProject && (
        <div className={styles.modalOverlay}>
          <div className={styles.modal}>
            <h2 className={styles.modalTitle}>{t("createdTitle")}</h2>
            <p className={styles.modalSubtitle}>{t("createdSubtitle")}</p>
